...
| --------------------------------------------------------------------- | --------- | ------ |
| **Deployed v2** — hybrid (BM25+vector, RRF) + query decomposition + Jina reranker | **0.80** (32/40) | **0.98** (44/45) |
